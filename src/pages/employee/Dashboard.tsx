...
const benefits = [
  ...
  { name: 'Transport Allowance', nameKey: 'benefit.transport', icon: Car, value: 24000, utilized: 18000, type: 'cash_allowances', area: 'mobility', route: '/employee/transport', bullets: ['Paid monthly with salary', 'Covers fuel and parking'], bulletsAr: ['يُدفع شهرياً مع الراتب', 'يغطي الوقود والمواقف'] },
  { name: 'Annual Flight Tickets', nameKey: 'benefit.flights', icon: Plane, value: 15000, utilized: 15000, type: 'cash_allowances', area: 'lifestyle', route: '/employee/transport', bullets: ['For employee and dependents', 'Economy class tickets'], bulletsAr: ['للموظف والمعالين', 'تذاكر الدرجة الاقتصادية'] },
  { name: 'Annual Bonus', nameKey: 'benefit.bonus', icon: Gift, value: 70000, utilized: 0, type: 'cash_allowances', area: 'money', route: '/employee/financial', bullets: ['Performance-based (up to 200%)', 'Paid annually in March', 'Target: 2 months salary'], bulletsAr: ['مبني على الأداء (حتى ٢٠٠٪)', 'يُدفع سنوياً في مارس', 'الهدف: راتب شهرين'] },
