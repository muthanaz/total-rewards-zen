...
const pageTranslations = {
  en: {
    ...
    schoolingAllowance: 'Schooling Allowance',
    schoolingDesc: 'School fee coverage for up to 3 children',
  ...
  ar: {
    ...
    housingDesc: 'دعم سكني شهري حتى AED 12,000',
    schoolingAllowance: 'بدل التعليم المدرسي',
    schoolingDesc: 'تغطية الرسوم المدرسية لما يصل إلى 3 أطفال',
    healthInsurance: 'التأمين الصحي',
    healthDesc: 'تغطية طبية ممتازة لك ولعائلتك',
    transportAllowance: 'بدل النقل',
    transportDesc: 'دعم نقل شهري بقيمة AED 2,500',
...
const benefits = [
  ...
  { id: 'education', icon: GraduationCap, nameKey: 'schoolingAllowance', descKey: 'schoolingDesc', value: 80000, included: true },
