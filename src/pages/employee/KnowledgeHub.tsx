...
const glossaryTerms = {
  en: [
    ...
    { term: 'Schooling Allowance', definition: 'Financial support for children\'s schooling expenses including tuition fees, books, uniforms, and transportation.', category: 'Education', related: ['Tuition Fee', 'School Enrollment'] },
