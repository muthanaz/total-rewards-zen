          ...
          <Card className="border-primary/20 bg-primary/5">
            <CardHeader>
              <CardTitle className={cn("flex items-center gap-2", isRTL && "flex-row-reverse")}>
                ...
                {language === 'ar' ? 'البيانات المطلوبة' : 'Required Data Fields & Formats'}
              </CardTitle>
              <CardDescription>
                {language === 'ar' 
                  ? 'الحقول المطلوبة لكل نوع من أنواع البيانات'
                  : 'Exact fields and formats required for successful data imports'}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="p-4 border rounded-lg bg-background">
                  <h4 className="font-semibold text-sm flex items-center gap-2 mb-3">
                    ...
                    {language === 'ar' ? 'بيانات الموظفين' : 'Employee Master'}
                  </h4>
                  <ul className="text-xs space-y-1 text-muted-foreground">
                    <li><code className="bg-muted px-1 rounded">employee_id</code> - Unique ID (required)</li>
                    <li><code className="bg-muted px-1 rounded">email</code> - Email address (required)</li>
                    <li><code className="bg-muted px-1 rounded">first_name</code> - First name (required)</li>
                    <li><code className="bg-muted px-1 rounded">last_name</code> - Last name (required)</li>
                    <li><code className="bg-muted px-1 rounded">department</code> - Department name</li>
                    <li><code className="bg-muted px-1 rounded">grade</code> - G1-G10 (required)</li>
                    <li><code className="bg-muted px-1 rounded">employment_date</code> - YYYY-MM-DD</li>
                    <li><code className="bg-muted px-1 rounded">monthly_salary</code> - Number in AED</li>
                  </ul>
                </div>
                ...
                <div className="p-4 border rounded-lg bg-background">
                  <h4 className="font-semibold text-sm flex items-center gap-2 mb-3">
                    ...
                    {language === 'ar' ? 'استحقاقات المزايا' : 'Benefit Entitlements'}
                  </h4>
                  <ul className="text-xs space-y-1 text-muted-foreground">
                    <li><code className="bg-muted px-1 rounded">employee_id</code> - Match employee (required)</li>
                    <li><code className="bg-muted px-1 rounded">benefit_id</code> - Benefit code (required)</li>
                    <li><code className="bg-muted px-1 rounded">annual_allowance</code> - Number in AED</li>
                    <li><code className="bg-muted px-1 rounded">utilized_amount</code> - Amount used</li>
                    <li><code className="bg-muted px-1 rounded">effective_date</code> - YYYY-MM-DD</li>
                  </ul>
                </div>
                ...
                <div className="p-4 border rounded-lg bg-background">
                  <h4 className="font-semibold text-sm flex items-center gap-2 mb-3">
                    ...
                    {language === 'ar' ? 'أحداث الاستخدام' : 'Utilization Events'}
                  </h4>
                  <ul className="text-xs space-y-1 text-muted-foreground">
                    <li><code className="bg-muted px-1 rounded">employee_id</code> - Match employee (required)</li>
                    <li><code className="bg-muted px-1 rounded">benefit_id</code> - Benefit code (required)</li>
                    <li><code className="bg-muted px-1 rounded">event_type</code> - claim/adjustment/topup</li>
                    <li><code className="bg-muted px-1 rounded">amount</code> - Number in AED</li>
                    <li><code className="bg-muted px-1 rounded">event_date</code> - YYYY-MM-DD</li>
                    <li><code className="bg-muted px-1 rounded">description</code> - Event details</li>
                  </ul>
                </div>
                ...
                <div className="p-4 border rounded-lg bg-background">
                  <h4 className="font-semibold text-sm flex items-center gap-2 mb-3">
                    <Users className="w-4 h-4 text-primary" />
                    {language === 'ar' ? 'المعالين' : 'Dependents'}
                  </h4>
                  <ul className="text-xs space-y-1 text-muted-foreground">
                    <li><code className="bg-muted px-1 rounded">employee_id</code> - Match employee (required)</li>
                    <li><code className="bg-muted px-1 rounded">name</code> - Dependent name (required)</li>
                    <li><code className="bg-muted px-1 rounded">relationship</code> - spouse/child/parent</li>
                    <li><code className="bg-muted px-1 rounded">date_of_birth</code> - YYYY-MM-DD</li>
                    <li><code className="bg-muted px-1 rounded">school_name</code> - For children</li>
                    <li><code className="bg-muted px-1 rounded">grade</code> - Grade/year level</li>
                  </ul>
                </div>
                ...
                <div className="p-4 border rounded-lg bg-background">
                  <h4 className="font-semibold text-sm flex items-center gap-2 mb-3">
                    ...
                    {language === 'ar' ? 'أرصدة الإجازات' : 'Leave Balances'}
                  </h4>
                  <ul className="text-xs space-y-1 text-muted-foreground">
                    <li><code className="bg-muted px-1 rounded">employee_id</code> - Match employee (required)</li>
                    <li><code className="bg-muted px-1 rounded">leave_type</code> - annual/sick/compassionate</li>
                    <li><code className="bg-muted px-1 rounded">total_days</code> - Number</li>
                    <li><code className="bg-muted px-1 rounded">used_days</code> - Number</li>
                    <li><code className="bg-muted px-1 rounded">year</code> - YYYY</li>
                  </ul>
                </div>
                ...
                <div className="p-4 border rounded-lg bg-background">
                  <h4 className="font-semibold text-sm flex items-center gap-2 mb-3">
                    ...
                    {language === 'ar' ? 'ميزانية المؤسسة' : 'Organization Budget'}
                  </h4>
                  <ul className="text-xs space-y-1 text-muted-foreground">
                    <li><code className="bg-muted px-1 rounded">fiscal_year</code> - YYYY (required)</li>
                    <li><code className="bg-muted px-1 rounded">annual_budget</code> - Number in AED</li>
                    <li><code className="bg-muted px-1 rounded">budget_allocated</code> - JSON object</li>
                    <li className="text-xs italic mt-2">
                      budget_allocated format: {`{"housing": 500000, "health": 200000, ...}`}
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-4 p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {language === 'ar' 
                    ? 'جميع التواريخ يجب أن تكون بتنسيق YYYY-MM-DD. جميع المبالغ المالية يجب أن تكون أرقامًا بدون رموز العملات.'
                    : 'All dates must be in YYYY-MM-DD format. All monetary amounts must be numbers without currency symbols.'}
                </p>
              </div>
            </CardContent>
          </Card>
