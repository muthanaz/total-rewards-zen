...
import { Info, Home, Users, Heart, DollarSign, Briefcase, Sparkles, Car } from 'lucide-react';
import { LIFE_AREA_LABELS, BENEFIT_TYPE_LABELS } from '@/lib/constants';
import { cn } from '@/lib/utils';

// Life Area icon mapping
const LIFE_AREA_ICONS: Record<string, React.ElementType> = {
  home_living: Home,
  family_parenting: Users,
  health: Heart,
  money: DollarSign,
  career: Briefcase,
  lifestyle: Sparkles,
...
// Life Area color mapping (semantic tokens)
const LIFE_AREA_COLORS: Record<string, string> = {
  home_living: 'bg-blue-500/10 text-blue-600 border-blue-500/20 dark:text-blue-400',
  family_parenting: 'bg-pink-500/10 text-pink-600 border-pink-500/20 dark:text-pink-400',
  health: 'bg-red-500/10 text-red-600 border-red-500/20 dark:text-red-400',
  money: 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20 dark:text-emerald-400',
  career: 'bg-purple-500/10 text-purple-600 border-purple-500/20 dark:text-purple-400',
  lifestyle: 'bg-amber-500/10 text-amber-600 border-amber-500/20 dark:text-amber-400',
  mobility: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/20 dark:text-cyan-400',
};
