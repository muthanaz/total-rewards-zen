...
interface OpsHubOverviewProps {
  onNavigateToPayments?: () => void;
}

export function OpsHubOverview({ onNavigateToPayments }: OpsHubOverviewProps) {
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">
            High-level operational health across claims, SLA, and payments.
          </p>
        </div>
        ...
        <HROpsPaymentsPipeline
          ...
          onExportClick={() => {
            if (onNavigateToPayments) {
              ...
              navigate('/employer/settlements?action=export');
            }
          }}
        />
      </div>
