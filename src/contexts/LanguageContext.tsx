...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'employee.dashboard.annualBenefits': 'Annual Entitlement',
    ...
    'employee.dashboard.benefitHighlights': 'Benefits Summary',
    'employee.dashboard.fullyUtilized': 'Fully Utilized',
    'employee.dashboard.roomToUse': 'Remaining Entitlement',
    'employee.dashboard.thisMonth': 'This Period',
    'employee.dashboard.yourBenefits': 'Your Benefits',
    'employee.dashboard.utilizationByType': 'Utilization by Category',
    'employee.dashboard.overallUsage': 'Overall Utilization',
    'employee.dashboard.benefitComparison': 'Utilization Comparison',
    'employee.dashboard.yourUtilization': 'Your Utilization',
    'employee.dashboard.companyAvg': 'Org. Average',
    'employee.dashboard.requestClaim': 'Claims & Requests',
    'employee.dashboard.benefitsAt100': 'fully utilized',
    'employee.dashboard.benefitsWithRemaining': 'with remaining entitlement',
    'employee.dashboard.perkActivations': 'perk activations',
    'employee.dashboard.claimsApproved': 'approved claims',
    'employee.dashboard.clickBarDetails': 'Select any category for detailed breakdown',
    'employee.dashboard.used': 'Utilized',
    'employee.dashboard.remaining': 'Remaining',
    
    // Benefit Categories (Professional HR Terminology)
    'benefit.cash_allowances': 'Cash Entitlements',
    'benefit.health_protection': 'Health & Protection',
    'benefit.time_off_flex': 'Leave & Flexibility',
    'benefit.growth_career': 'Career Development',
    'benefit.wealth_ownership': 'Wealth & Equity',
    
    // Benefits - Unified naming (use these consistently across all pages)
    'benefit.housing': 'Housing Entitlement',
    'benefit.education': 'Schooling Entitlement',
    'benefit.health': 'Medical Insurance',
    'benefit.transport': 'Transport & Mobility',
    'benefit.bonus': 'Performance Bonus',
    'benefit.financial': 'Financial Planning',
    'benefit.wellbeing': 'Wellbeing Program',
    'benefit.learning': 'Learning & Development',
    'benefit.equity': 'Equity Participation',
    ...
    'employer.dashboard.satisfaction': 'Adoption Rate',
    ...
    'employer.dashboard.zombieCandidates': 'Budget Leakage Candidates',
    ...
    'insight.zombieDecreased': 'Budget leakage decreased by AED 45K',
  ...
  ar: {
    ...
    'employer.dashboard.zombieSpend': 'تسرب الميزانية',
    'employer.dashboard.satisfaction': 'معدل التبني',
    ...
    'employer.dashboard.zombieCandidates': 'مرشحو تسرب الميزانية',
