...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.leave': 'Leave',
    'nav.learningDevelopment': 'Learning & Development',
    'nav.documentsClaims': 'Documents & Claims',
    'nav.housing': 'Housing',
    ...
    'nav.documents': 'Documents & Claims',
  ...
  ar: {
    ...
    'nav.leave': 'الإجازات',
    'nav.learningDevelopment': 'التعلم والتطوير',
    'nav.documentsClaims': 'المستندات والمطالبات',
    'nav.housing': 'السكن',
