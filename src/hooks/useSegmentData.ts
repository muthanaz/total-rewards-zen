...
const GRADE_VALUES: SegmentValue[] = [
  { id: 'g-m1', name: 'M1 (Entry)', headcount: 28, avgTotalComp: 180000, utilizationRate: 62, unusedEntitlement: 145000, claimsCost: 85000, claimsCostDelta: 12, satisfactionScore: 3.8, retentionRisk: 'medium', confidence: 'high', topCategories: ['Health', 'L&D', 'Transport'], slaRiskCount: 2, missingDocsCount: 5, overLimitCount: 0, drivers: [] },
  { id: 'g-m2', name: 'M2 (Junior)', headcount: 35, avgTotalComp: 240000, utilizationRate: 71, unusedEntitlement: 185000, claimsCost: 125000, claimsCostDelta: 8, satisfactionScore: 4.0, retentionRisk: 'medium', confidence: 'high', topCategories: ['Health', 'Transport', 'Wellbeing'], slaRiskCount: 1, missingDocsCount: 3, overLimitCount: 1, drivers: [] },
  { id: 'g-m3', name: 'M3 (Mid)', headcount: 32, avgTotalComp: 320000, utilizationRate: 78, unusedEntitlement: 156000, claimsCost: 180000, claimsCostDelta: -2, satisfactionScore: 4.2, retentionRisk: 'low', confidence: 'high', topCategories: ['Housing', 'Health', 'Schooling'], slaRiskCount: 0, missingDocsCount: 2, overLimitCount: 0, drivers: [] },
  { id: 'g-m4', name: 'M4 (Senior)', headcount: 20, avgTotalComp: 450000, utilizationRate: 85, unusedEntitlement: 98000, claimsCost: 220000, claimsCostDelta: 5, satisfactionScore: 4.3, retentionRisk: 'low', confidence: 'high', topCategories: ['Housing', 'Schooling', 'Flight'], slaRiskCount: 1, missingDocsCount: 1, overLimitCount: 2, drivers: [] },
  { id: 'g-m5', name: 'M5 (Manager)', headcount: 10, avgTotalComp: 620000, utilizationRate: 91, unusedEntitlement: 45000, claimsCost: 185000, claimsCostDelta: 3, satisfactionScore: 4.5, retentionRisk: 'low', confidence: 'high', topCategories: ['Housing', 'Flight', 'Equity'], slaRiskCount: 0, missingDocsCount: 0, overLimitCount: 1, drivers: [] },
  { id: 'g-m6', name: 'M6+ (Director+)', headcount: 5, avgTotalComp: 950000, utilizationRate: 94, unusedEntitlement: 28000, claimsCost: 125000, claimsCostDelta: -5, satisfactionScore: 4.7, retentionRisk: 'low', confidence: 'high', topCategories: ['Equity', 'Executive Health', 'Flight'], slaRiskCount: 0, missingDocsCount: 0, overLimitCount: 0, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));

const DEPARTMENT_VALUES: SegmentValue[] = [
  { id: 'd-eng', name: 'Engineering', headcount: 42, avgTotalComp: 380000, utilizationRate: 72, unusedEntitlement: 210000, claimsCost: 195000, claimsCostDelta: 15, satisfactionScore: 4.1, retentionRisk: 'medium', confidence: 'high', topCategories: ['L&D', 'Health', 'Wellbeing'], slaRiskCount: 2, missingDocsCount: 4, overLimitCount: 1, drivers: [] },
  { id: 'd-sales', name: 'Sales', headcount: 28, avgTotalComp: 420000, utilizationRate: 81, unusedEntitlement: 125000, claimsCost: 165000, claimsCostDelta: 22, satisfactionScore: 3.9, retentionRisk: 'high', confidence: 'high', topCategories: ['Transport', 'Health', 'Flight'], slaRiskCount: 1, missingDocsCount: 2, overLimitCount: 0, drivers: [] },
  { id: 'd-ops', name: 'Operations', headcount: 22, avgTotalComp: 290000, utilizationRate: 68, unusedEntitlement: 165000, claimsCost: 98000, claimsCostDelta: 8, satisfactionScore: 3.7, retentionRisk: 'high', confidence: 'medium', topCategories: ['Health', 'Transport', 'Leave'], slaRiskCount: 3, missingDocsCount: 6, overLimitCount: 2, drivers: [] },
  { id: 'd-hr', name: 'HR', headcount: 12, avgTotalComp: 310000, utilizationRate: 88, unusedEntitlement: 42000, claimsCost: 52000, claimsCostDelta: -3, satisfactionScore: 4.4, retentionRisk: 'low', confidence: 'high', topCategories: ['L&D', 'Wellbeing', 'Health'], slaRiskCount: 0, missingDocsCount: 1, overLimitCount: 0, drivers: [] },
  { id: 'd-fin', name: 'Finance', headcount: 16, avgTotalComp: 350000, utilizationRate: 76, unusedEntitlement: 98000, claimsCost: 85000, claimsCostDelta: 5, satisfactionScore: 4.0, retentionRisk: 'low', confidence: 'high', topCategories: ['Health', 'Housing', 'L&D'], slaRiskCount: 1, missingDocsCount: 2, overLimitCount: 1, drivers: [] },
  { id: 'd-legal', name: 'Legal', headcount: 10, avgTotalComp: 520000, utilizationRate: 84, unusedEntitlement: 55000, claimsCost: 78000, claimsCostDelta: 0, satisfactionScore: 4.2, retentionRisk: 'low', confidence: 'high', topCategories: ['Health', 'Flight', 'L&D'], slaRiskCount: 0, missingDocsCount: 0, overLimitCount: 0, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));

const NATIONALITY_VALUES: SegmentValue[] = [
  { id: 'n-uae', name: 'UAE National', headcount: 18, avgTotalComp: 480000, utilizationRate: 89, unusedEntitlement: 52000, claimsCost: 145000, claimsCostDelta: 2, satisfactionScore: 4.5, retentionRisk: 'low', confidence: 'high', topCategories: ['Housing', 'Schooling', 'Health'], slaRiskCount: 0, missingDocsCount: 1, overLimitCount: 0, drivers: [] },
  { id: 'n-gcc', name: 'GCC Expat', headcount: 12, avgTotalComp: 350000, utilizationRate: 82, unusedEntitlement: 68000, claimsCost: 95000, claimsCostDelta: 5, satisfactionScore: 4.1, retentionRisk: 'low', confidence: 'medium', topCategories: ['Flight', 'Health', 'Schooling'], slaRiskCount: 1, missingDocsCount: 2, overLimitCount: 0, drivers: [] },
  { id: 'n-other', name: 'Other Expat', headcount: 100, avgTotalComp: 320000, utilizationRate: 74, unusedEntitlement: 540000, claimsCost: 420000, claimsCostDelta: 18, satisfactionScore: 3.8, retentionRisk: 'medium', confidence: 'high', topCategories: ['Health', 'Housing', 'Flight'], slaRiskCount: 3, missingDocsCount: 8, overLimitCount: 3, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));

const LIFE_STAGE_VALUES: SegmentValue[] = [
  { id: 'ls-single', name: 'Single', headcount: 45, avgTotalComp: 260000, utilizationRate: 65, unusedEntitlement: 285000, claimsCost: 165000, claimsCostDelta: 10, satisfactionScore: 3.9, retentionRisk: 'medium', confidence: 'medium', topCategories: ['L&D', 'Wellbeing', 'Transport'], slaRiskCount: 2, missingDocsCount: 5, overLimitCount: 1, drivers: [] },
  { id: 'ls-married', name: 'Married (No Kids)', headcount: 32, avgTotalComp: 380000, utilizationRate: 76, unusedEntitlement: 165000, claimsCost: 185000, claimsCostDelta: 8, satisfactionScore: 4.1, retentionRisk: 'low', confidence: 'medium', topCategories: ['Health', 'Housing', 'Flight'], slaRiskCount: 1, missingDocsCount: 3, overLimitCount: 1, drivers: [] },
  { id: 'ls-family', name: 'With Dependents', headcount: 53, avgTotalComp: 450000, utilizationRate: 88, unusedEntitlement: 152000, claimsCost: 380000, claimsCostDelta: 15, satisfactionScore: 4.3, retentionRisk: 'low', confidence: 'high', topCategories: ['Schooling', 'Health', 'Housing'], slaRiskCount: 1, missingDocsCount: 3, overLimitCount: 2, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));

const WORK_ARRANGEMENT_VALUES: SegmentValue[] = [
  { id: 'wa-onsite', name: 'Onsite', headcount: 78, avgTotalComp: 340000, utilizationRate: 79, unusedEntitlement: 320000, claimsCost: 385000, claimsCostDelta: 12, satisfactionScore: 4.0, retentionRisk: 'low', confidence: 'medium', topCategories: ['Health', 'Transport', 'Meals'], slaRiskCount: 2, missingDocsCount: 6, overLimitCount: 2, drivers: [] },
  { id: 'wa-hybrid', name: 'Hybrid', headcount: 42, avgTotalComp: 380000, utilizationRate: 73, unusedEntitlement: 195000, claimsCost: 210000, claimsCostDelta: 8, satisfactionScore: 4.2, retentionRisk: 'low', confidence: 'low', topCategories: ['Health', 'L&D', 'Wellbeing'], slaRiskCount: 1, missingDocsCount: 3, overLimitCount: 1, drivers: [] },
  { id: 'wa-remote', name: 'Remote', headcount: 10, avgTotalComp: 420000, utilizationRate: 68, unusedEntitlement: 85000, claimsCost: 45000, claimsCostDelta: -5, satisfactionScore: 4.4, retentionRisk: 'medium', confidence: 'low', topCategories: ['L&D', 'Wellbeing', 'Internet'], slaRiskCount: 1, missingDocsCount: 2, overLimitCount: 0, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));

const JOINER_COHORT_VALUES: SegmentValue[] = [
  { id: 'jc-0-6', name: '0-6 months', headcount: 22, avgTotalComp: 280000, utilizationRate: 48, unusedEntitlement: 245000, claimsCost: 65000, claimsCostDelta: 5, satisfactionScore: 4.0, retentionRisk: 'high', confidence: 'high', topCategories: ['Health', 'L&D', 'Transport'], slaRiskCount: 4, missingDocsCount: 8, overLimitCount: 0, drivers: [] },
  { id: 'jc-6-12', name: '6-12 months', headcount: 28, avgTotalComp: 310000, utilizationRate: 68, unusedEntitlement: 175000, claimsCost: 95000, claimsCostDelta: 12, satisfactionScore: 4.1, retentionRisk: 'medium', confidence: 'high', topCategories: ['Health', 'Transport', 'Wellbeing'], slaRiskCount: 2, missingDocsCount: 4, overLimitCount: 1, drivers: [] },
  { id: 'jc-1-3', name: '1-3 years', headcount: 45, avgTotalComp: 360000, utilizationRate: 82, unusedEntitlement: 142000, claimsCost: 245000, claimsCostDelta: 8, satisfactionScore: 4.2, retentionRisk: 'low', confidence: 'high', topCategories: ['Housing', 'Health', 'Schooling'], slaRiskCount: 1, missingDocsCount: 2, overLimitCount: 1, drivers: [] },
  { id: 'jc-3plus', name: '3+ years', headcount: 35, avgTotalComp: 450000, utilizationRate: 91, unusedEntitlement: 95000, claimsCost: 285000, claimsCostDelta: 3, satisfactionScore: 4.5, retentionRisk: 'low', confidence: 'high', topCategories: ['Schooling', 'Housing', 'Equity'], slaRiskCount: 0, missingDocsCount: 1, overLimitCount: 2, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));

const EMPLOYMENT_TYPE_VALUES: SegmentValue[] = [
  { id: 'et-ft', name: 'Full-time', headcount: 115, avgTotalComp: 380000, utilizationRate: 80, unusedEntitlement: 520000, claimsCost: 580000, claimsCostDelta: 10, satisfactionScore: 4.2, retentionRisk: 'low', confidence: 'high', topCategories: ['Health', 'Housing', 'Schooling'], slaRiskCount: 3, missingDocsCount: 8, overLimitCount: 3, drivers: [] },
  { id: 'et-pt', name: 'Part-time', headcount: 8, avgTotalComp: 150000, utilizationRate: 55, unusedEntitlement: 45000, claimsCost: 25000, claimsCostDelta: 5, satisfactionScore: 3.8, retentionRisk: 'medium', confidence: 'medium', topCategories: ['Health', 'L&D'], slaRiskCount: 1, missingDocsCount: 2, overLimitCount: 0, drivers: [] },
  { id: 'et-ct', name: 'Contractor', headcount: 7, avgTotalComp: 420000, utilizationRate: 42, unusedEntitlement: 92000, claimsCost: 35000, claimsCostDelta: -8, satisfactionScore: 3.5, retentionRisk: 'high', confidence: 'low', topCategories: ['L&D'], slaRiskCount: 0, missingDocsCount: 1, overLimitCount: 0, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));

const COMPENSATION_BAND_VALUES: SegmentValue[] = [
  { id: 'cb-q1', name: 'Q1 (Bottom 25%)', headcount: 32, avgTotalComp: 180000, utilizationRate: 58, unusedEntitlement: 185000, claimsCost: 95000, claimsCostDelta: 8, satisfactionScore: 3.6, retentionRisk: 'high', confidence: 'high', topCategories: ['Health', 'Transport'], slaRiskCount: 3, missingDocsCount: 6, overLimitCount: 0, drivers: [] },
  { id: 'cb-q2', name: 'Q2 (25-50%)', headcount: 33, avgTotalComp: 280000, utilizationRate: 72, unusedEntitlement: 165000, claimsCost: 145000, claimsCostDelta: 10, satisfactionScore: 4.0, retentionRisk: 'medium', confidence: 'high', topCategories: ['Health', 'Housing', 'L&D'], slaRiskCount: 2, missingDocsCount: 4, overLimitCount: 1, drivers: [] },
  { id: 'cb-q3', name: 'Q3 (50-75%)', headcount: 33, avgTotalComp: 420000, utilizationRate: 82, unusedEntitlement: 125000, claimsCost: 225000, claimsCostDelta: 5, satisfactionScore: 4.2, retentionRisk: 'low', confidence: 'high', topCategories: ['Housing', 'Health', 'Schooling'], slaRiskCount: 1, missingDocsCount: 2, overLimitCount: 1, drivers: [] },
  { id: 'cb-q4', name: 'Q4 (Top 25%)', headcount: 32, avgTotalComp: 680000, utilizationRate: 90, unusedEntitlement: 82000, claimsCost: 320000, claimsCostDelta: 2, satisfactionScore: 4.5, retentionRisk: 'low', confidence: 'high', topCategories: ['Housing', 'Schooling', 'Equity'], slaRiskCount: 0, missingDocsCount: 1, overLimitCount: 2, drivers: [] },
].map(v => ({ ...v, drivers: generateDrivers(v.utilizationRate, v.slaRiskCount, v.missingDocsCount) }));
